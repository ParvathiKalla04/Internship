...
def main():
    ...
    html_temp = """
    <div style="background-color:#33FFFB;padding:10px">
    <h2 style="color:white;text-align:center;">TESLA Close Price Predictor</h2>
    </div>
    """
    ...
    cmpd,negt,neut,np.positive = sent_anls(head)
